...
class CreateBacSiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'chuc_danh'             => 'required|string|max:100',
            'so_nam_kinh_nghiem'    => 'required|integer|min:0|max:50',
            'mo_ta'                 => 'required|string|max:500',
            'kinh_nghiem_lam_viec'  => 'required|string|max:1000',
            'qua_trinh_dao_tao'     => 'required|string|max:1000',
            'chung_chi'             => 'required|string|max:500',
            'thanh_tuu'             => 'required|string|max:500',
            'thanh_vien_to_chuc'    => 'required|string|max:500',
            'tinh_trang'            => 'required|boolean',
            'hinh_anh'              => 'required|string|max:255',
            'chuyen_khoa'           => 'required|array',
            'chuyen_khoa.*'         => 'required|exists:chuyen_khoas,id',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'chuc_danh.string'               => 'Chức danh phải là chuỗi ký tự',
            ...
            'so_nam_kinh_nghiem.min'         => 'Số năm kinh nghiệm không được nhỏ hơn 0',
            'so_nam_kinh_nghiem.max'         => 'Số năm kinh nghiệm không được lớn hơn 50',
            ...
            'kinh_nghiem_lam_viec.string'    => 'Kinh nghiệm làm việc phải là chuỗi ký tự',
            ...
            'chuyen_khoa.required'           => 'Chuyên khoa không được để trống',
            'chuyen_khoa.array'              => 'Chuyên khoa phải là một mảng',
            'chuyen_khoa.*.required'         => 'Chuyên khoa không được để trống',
            'chuyen_khoa.*.exists'           => 'Chuyên khoa không tồn tại trong hệ thống',
        ];
    }
}
