...
class PhieuDatLichController extends Controller
{
    ...
    public function nhacKhamBenh()
    {
        ...
        foreach ($data as $key => $value) {
            $payload = [
                'ho_ten'       => $value->ho_ten,
                'ngay_dat_hen' => $value->ngay_dat_hen,
                'ly_do_kham'   => $value->ly_do_kham,
            ];

            SendMailJob::dispatch($payload, 'loi_nhac_lich_hen', 'Thông báo lịch khám', "ddt.jun1202@gmail.com");
            // return
        }
    }
}
