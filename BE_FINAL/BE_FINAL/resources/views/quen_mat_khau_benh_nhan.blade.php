...
<head>
    ...
    <title>Quên mật khẩu - Bệnh nhân</title><!--[if (mso 16)]>
    <style type="text/css">
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        {{ $data['ho_ten'] }}<br>Chúng tôi nhận được yêu
                                                                        cầu đặt lại mật khẩu cho tài khoản bệnh nhân của
                                                                        bạn. Để hoàn tất quá trình này, vui lòng làm
                                                                        theo các bước sau:</p>
                                                                    <ol>
                                                                        <li
                                                                            ...
                                                                            Nhấp vào nút "ĐẶT LẠI MẬT KHẨU" bên dưới.
                                                                        </li>
                                                                        <li
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;margin-left:0;color:#333333;font-size:14px">
                                                                        ...
                                                                        <li
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;Margin-bottom:15px;margin-left:0;color:#333333;font-size:14px">
                                                                            Xác nhận mật khẩu mới và hoàn tất.</li>
                                                                    </ol>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#2CB543;background:#667eea;border-width:0px;display:inline-block;border-radius:6px;width:auto"><a
                                                                            href="{{ $data['link'] }}" class="es-button"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;padding:10px 30px 10px 30px;display:inline-block;background:#667eea;border-radius:6px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;mso-padding-alt:0;mso-border-alt:10px solid #667eea;padding-left:30px;padding-right:30px">ĐẶT
                                                                            LẠI MẬT KHẨU</a></span></td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Liên kết này chỉ có giá trị trong 60 phút.</h3>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        bỏ qua email này. Tài khoản của bạn sẽ vẫn an
                                                                        toàn và không có thay đổi nào được thực hiện.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                                        <p
                                                            ...
                                                            © <a href="http://localhost:5173/"
                                                                style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px">Hệ
                                                                thống Quản lý Phòng khám</a>, All Right Reserved.</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
