<template>
    <div class="nav-container primary-menu">
        <div class="mobile-topbar-header">
            <div>
                <img src="https://img5.thuthuatphanmem.vn/uploads/2021/07/12/logo-benh-vien-my_090236370.png" class="logo-icon" alt="logo icon">
            </div>
            <div>
        ...
        <nav class="navbar navbar-expand-xl w-100">
            <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
                ...
                <!-- Quản lý Slide -->
                <li class="nav-item">
                    <router-link to="/admin/slide" class="nav-link">
                ...
                <!-- Kiểm tra phiếu đặt lịch -->
                <li class="nav-item">
                    <router-link to="/admin/kiem-tra-phieu-dat-lich" class="nav-link">
                        <div class="parent-icon"><i class="bx bx-calendar"></i></div>
                        <div class="menu-title">Kiểm tra phiếu đặt lịch</div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/thong-ke/bac-si-theo-phong-kham" class="nav-link">
                                <div class="parent-icon"><i class="bx bx-calendar"></i></div>
                                <div class="menu-title">Bác sĩ theo phòng khám</div>
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/admin/thong-ke/lich-lam-viec-theo-phong-kham" class="nav-link">
                                <div class="parent-icon"><i class="bx bx-calendar"></i></div>
                                <div class="menu-title">Lịch làm việc theo phòng khám</div>
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/admin/thong-ke/benh-nhan-theo-bac-si" class="nav-link">
                                <div class="parent-icon"><i class="bx bx-calendar"></i></div>
                                <div class="menu-title">Bệnh nhân theo bác sĩ</div>
                            </router-link>
                        </li>
                    </ul>
                </li>
