                            ...
                            <div class="card-body">
                                <div class="p-5">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input v-model="bac_si.password" type="text" class="form-control" placeholder="Nhập mật khẩu của bạn">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Xác nhận mật khẩu</label>
                                        <input v-model="bac_si.re_password" type="text" class="form-control" placeholder="Nhập lại mật khẩu của bạn">
                                    </div>
...
export default {
    ...
    data() {
        return {
            bac_si : {
                'id_bac_si': this.id_bac_si,
            }
        }
    },
    methods: {
        LayLaiMatKhau() {
            baseRequestBacsi.post('bac-si/doi-mat-khau', this.bac_si)
                    .then((res) => {
                    if (res.data.status) {
