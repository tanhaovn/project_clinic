                      ...
                      <div class="row ">
                          <template v-for="(value, idx) in list_chuyen_khoa" :key="idx">
                              <div class="col-lg-3 col-md-4 col-sm-6 mb-4 d-flex">
                                  <div class="card border-0 shadow-sm h-100 w-100 rounded-4 overflow-hidden"
                                      ...
                                      <div class="card-body p-4">
                                          <div class="text-center mb-3">
                                              ...
                                              <p class="text-primary mb-2">{{ value.ten_chuyen_khoa }}</p>
                                          </div>
                                          <p class="text-muted small mb-4" style="min-height: 60px;">{{ value.mo_ta }}</p>
                                          
                                      </div>
                                      <div class="card-footer">
                                        <div class="d-grid gap-2">
                                              <router-link :to="`/chuyen-khoa/chi-tiet/${value.id}`" class="btn btn-primary py-2 fw-semibold">
                                                  <i class="fa-regular fa-calendar-check me-2"></i>Đặt lịch khám
                                              </router-link>
                                              <router-link :to="`/chuyen-khoa/chi-tiet/${value.id}`" class="btn btn-outline-primary py-2">
