...
<div class="text-center mb-4">
  ...
  >
    ...
    <g id="handRight" class="hand" transform="translate(0,60)">
      ...
      <!-- TIÊU ĐỀ -->
      <div class="text-center mb-4">
        <h3 class="fw-bold text-primary">Đăng nhập Bệnh nhân</h3>
      </div>
      ...
      <form @submit.prevent="DangNhap">
        ...
        <div class="mb-3 text-end">
          <router-link to="/quen-mat-khau" class="btn btn-link px-0">Quên mật khẩu?</router-link>
        </div>
...
export default {
  ...
  methods: {
    DangNhap() {
      baseRequestBenhNhan
        .post("benh-nhan/login", this.user)
        .then((res) => {
          if (res.data.status) {
