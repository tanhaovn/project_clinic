<template>
    <div class="receipt-container">
        <div class="receipt">
            <div class="header">
                <div class="logo">Hospital Future Vision</div>
                <div class="hospital-info">
                    <div class="address">Phú Cang 2, Vạn Phú, Vạn Ninh, Khánh Hòa</div>
                    <div>Email: phamtanhao1909@gmail.com</div>
                    <div>Tel: 0961 651 933</div>
                </div>
            </div>
            ...
            <div class="transaction-info">
                <div class="transaction-id">
                    <img style="width: 100%;"
                        :src="`https://barcode.tec-it.com/barcode.ashx?data=` + info.ma_dat_lich + ` &multiplebarcodes=true&translate-esc=on`"
                        alt="">
                </div>
            </div>
            ...
            <div class="qr-section">
                <div class="qr-code">
                    <img src="/src/assets/images/QR.png" alt="QR Code" width="70" height="70">
            ...
            <div class="footer">
                ...
                <div class="website">http://localhost:5173/admin</div>
            </div>
        </div>
    </div>
</template>
