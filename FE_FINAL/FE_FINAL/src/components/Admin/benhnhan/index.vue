        ...
        <div class="col-12">
            <div class="card radius-10 border-top border-0 border-3 border-info">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <button @click="xuatExcel()" class="btn btn-primary">
                            <i class='bx bx-plus me-1'></i>Xuất Excel
                        </button>
                        <button class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#themMoiModal">
...
export default {
    ...
    methods: {
        ...
        xuatExcel() {
            ...
            axios
                .post("http://localhost:8000/api/admin/benh-nhan/export-excel", this.timKiem, {
                    responseType: "blob",
                    headers: {
                ...
                .then((res) => {
                    ...
                    a.href = url;
                    a.download = "Danh_sach_benh_nhan.xlsx";
                    a.click();
