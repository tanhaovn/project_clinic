  ...
  <div class="container py-4">
    <div class="row justify-content-center">
        ...
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <div class="input-group">
              <input type="text" class="form-control" v-model="search.ma_dat_lich" placeholder="Nhập mã đặt lịch"
                @keyup.enter="timKiem" />
      ...
      <div class="col-lg-7">
        ...
        <!-- Thông tin phiếu -->
        <div v-if="status === 1" class="card shadow-lg border-0">
          <div class="card-header d-flex justify-content-between align-items-center text-white"
            ...
            <span class="badge" :class="phieu.is_thanh_toan === 1 ? 'bg-success' : 'bg-warning text-dark'">
