    ...
    <div class="receipt-container">
        <div class="receipt">
            ...
            <div class="patient-section">
                ...
                <div class="patient-details">
                    <div class="patient-detail">
                        ...
                        <span class="detail-value">Nguyễn Văn An</span>
                    </div>
                    <div class="patient-detail">
            ...
            <div class="qr-section">
                <div class="qr-code">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=70x70&data=DZCare-HD-20250926-001-HDBS123123-NguyenVanAn&format=png" alt="QR Code">
                </div>
...
export default {
    ...
    methods: {
        loadBill(){
            ...
            baseRequestAdmin.post("admin/hoa-don/chi-tiet")
        }
    }
}
</script>
